    ...
    def calculate(
        ...
        *,
        ...
        if (
            not tooth_fdi
            or len(tooth_fdi) != 2
            or tooth_fdi[0] not in "1234"
            or tooth_fdi[1] not in "12345678"
        ):
        ...
        recommendation = self.engine.recommend(
            {
                "fdi": tooth_fdi,
                "final_findings": [{"type": finding_type}],
        ...
        target_local = datetime(
            target_date.year, target_date.month, target_date.day, hour, tzinfo=zone
        )

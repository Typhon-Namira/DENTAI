...
export const PRODUCT_COPY = {
  en: {
    nav: { product: "Product", how: "How it works", pricing: "Pricing", safety: "Clinical & Safety", about: "About", login: "Sign in", access: "Request access" },
    hero: {
    ...
    workflow: {
      ...
      steps: [
        ...
        ["06", "Care follow-up", "Create follow-up timing and send configured patient reminders."],
        ["07", "Patient return", "Track responses and act when the patient returns to the clinic."]
      ]
    },
    plans: {
      kicker: "Two focused plans",
      title: "Choose analysis only—or close the follow-up loop.",
      scan: { name: "Teta2 Scan", tagline: "See what’s hiding in the OPG.", outcome: "Scan → Understand → Record", features: ["Unlimited OPG analysis during the subscription month", "AI-assisted possible findings", "Tooth/region organization where supported", "Visual highlighting on the OPG", "AI clinical report", "Smart patient profile", "OPG and analysis history"] },
      care: { name: "Teta2 Care", tagline: "Never lose a patient who needs follow-up.", outcome: "Scan → Understand → Record → Follow → Return", features: ["Everything in Teta2 Scan", "Smart follow-up workflow", "Problem/tooth-based follow-up timing", "Automated patient messages", "Patient response tracking", "Recall management", "Follow-up dashboard and history", "Patient-return tracking"] }
    },
    safety: {
      kicker: "Clinical safety by design",
      title: "AI supports the dentist. It does not replace clinical judgment.",
      body: "Teta2 presents AI-assisted possible findings for professional examination. The clinician remains responsible for review and care decisions.",
      items: [
    ...
    about: {
      ...
      lead: "We are building focused dental AI for OPG intelligence and patient follow-up—not a generic clinic CRM.",
    ...
    access: {
      ...
      note: "Use your existing Teta2 sales/onboarding contact to request a Scan or Care clinic workspace.",
    ...
    clinic: {
      ...
      messagesLead: "WhatsApp patient follow-up messaging for the selected patient.",
      careRecord: "Smart Patient File", overview: "Overview", opgHistory: "OPG History", findings: "Findings", timeline: "Follow-up", messageHistory: "Messages"
    }
  },
  hy: {
    nav: { product: "Արտադրանք", how: "Ինչպես է աշխատում", pricing: "Գներ", safety: "Կլինիկական անվտանգություն", about: "Մեր մասին", login: "Մուտք", access: "Մուտքի հարցում" },
    hero: {
    ...
    workflow: {
      ...
      steps: [
        ...
        ["03", "AI-ով վերլուծություն", "Teta2-ը ներկայացնում է հնարավոր հայտնաբերումներ՝ ատամնաբույժի զննման համար։"],
        ...
        ["06", "Care հետագա վերահսկում", "Սահմանեք վերահսկման ժամկետը և ուղարկեք կարգավորված հիշեցումներ։"],
        ["07", "Պացիենտի վերադարձ", "Հետևեք պատասխաններին և գործեք, երբ պացիենտը վերադառնում է կլինիկա։"]
      ]
    },
    plans: {
      kicker: "Երկու կենտրոնացված պլան",
      title: "Ընտրեք միայն վերլուծություն կամ ամբողջական հետագա վերահսկման շղթա։",
      scan: { name: "Teta2 Scan", tagline: "Տեսեք՝ ինչ է թաքնված OPG-ում։", outcome: "Սքան → Հասկանալ → Պահպանել", features: ["Անսահմանափակ OPG վերլուծություն բաժանորդագրության ամսվա ընթացքում", "AI-ով աջակցվող հնարավոր հայտնաբերումներ", "Ատամ/շրջան ըստ կազմակերպում, որտեղ աջակցվում է", "Տեսողական նշումներ OPG-ի վրա", "AI կլինիկական հաշվետվություն", "Խելացի պացիենտի քարտ", "OPG և վերլուծության պատմություն"] },
      care: { name: "Teta2 Care", tagline: "Մի կորցրեք պացիենտին, որը հետագա վերահսկման կարիք ունի։", outcome: "Սքան → Հասկանալ → Պահպանել → Հետևել → Վերադարձ", features: ["Ամեն ինչ Teta2 Scan-ից", "Խելացի հետագա վերահսկում", "Խնդրի/ատամի հիման վրա ժամկետավորում", "Ավտոմատ պացիենտի հաղորդագրություններ", "Պատասխանների վերահսկում", "Recall կառավարում", "Հետագա վերահսկման վահանակ և պատմություն", "Պացիենտի վերադարձի վերահսկում"] }
    },
    safety: {
      kicker: "Կլինիկական անվտանգություն ըստ դիզայնի",
      title: "AI-ն աջակցում է բժշկին և չի փոխարինում կլինիկական դատողությանը։",
      body: "Teta2-ը ներկայացնում է AI-ով աջակցվող հնարավոր հայտնաբերումներ մասնագիտական զննման համար։ Վերջնական վերանայման և բուժման որոշումը մնում է բժշկին։",
      items: [
    ...
    about: {
      ...
      lead: "Մենք կառուցում ենք կենտրոնացված dental AI՝ OPG ինտելեկտի և պացիենտի հետագա վերահսկման համար, ոչ թե ընդհանուր կլինիկական CRM։",
    ...
    access: {
      ...
      note: "Scan կամ Care կլինիկական workspace ստանալու համար օգտագործեք ձեր գործող Teta2 վաճառքի/onboarding կոնտակտը։",
    ...
    clinic: {
      ...
      newPatient: "Նոր պացիենտ", selectPatient: "Ընտրեք պացիենտ", upload: "Վերբեռնել OPG", analyze: "Գործարկել AI-ով վերլուծությունը",
      ...
      messagesLead: "WhatsApp-ով պացիենտի հետագա վերահսկման հաղորդագրություններ ընտրված պացիենտի համար։",
      careRecord: "Խելացի պացիենտի քարտ", overview: "Ակնարկ", opgHistory: "OPG պատմություն", findings: "Հայտնաբերումներ", timeline: "Հետագա վերահսկում", messageHistory: "Հաղորդագրություններ"
    }
  }
} as const;

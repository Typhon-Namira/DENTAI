...
import { explanationForGroup, localizedFindingType } from "../utils/clinicalSummary";
import { dashboardFinding, dashboardText, type DashboardLang } from "../product/dashboardI18n";
